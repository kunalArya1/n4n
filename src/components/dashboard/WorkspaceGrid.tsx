...
export default function WorkspaceGrid({
  ...
  async function handleCreate() {
    ...
    try {
      // Call the API to create the application/workspace
      const result = await createApplication(sessionToken, newName.trim(), newDescription.trim());
      
      // Add the created workspace to the state
      const ws: Workspace = {
  ...
  async function handleSoftDelete() {
    ...
    try {
      // Call the API to delete the application/workspace
      await deleteApplication(sessionToken, selectedWs.id);
