...
export default function WorkflowTrashGrid({
  workflows, onRestored, onPermanentDeleted, selectedIds, onSelectionChange,
  ...
  return (
    <div className="relative min-h-[500px]" onClick={() => onSelectionChange(new Set())}>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem className="text-destructive focus:text-destructive"
                      onClick={() => { setSelectedWf(wf); setPermanentDeleteOpen(true); }}>
      ...
      <Dialog open={batchDeleteOpen} onOpenChange={setBatchDeleteOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Delete {selectedIds.size} Workflow{selectedIds.size !== 1 ? "s" : ""} Permanently</DialogTitle>
          </DialogHeader>
          <p className="text-muted-foreground text-sm">
            Are you sure you want to permanently delete <strong>{selectedIds.size} workflow{selectedIds.size !== 1 ? "s" : ""}</strong>? This action cannot be undone.
          </p>
          <DialogFooter>
